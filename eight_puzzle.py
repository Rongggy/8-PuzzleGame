...
def process_file(filename, algorithm, param):
    ''' reads a file containing puzzles and solves using specified
        algorithm and param 
    '''
    ...
    if solved == 0:
        ...
        print("averages:", moves/solved, "moves", totstates/solved, "states tested")
